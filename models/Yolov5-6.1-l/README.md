...
```
$ cd SoyNet_model_market/models/Yolov5-6.1-l/weights && bash ./download_weights.sh
```

* Run
```
$ cd ../../../samples
$ python Yolov5-6.1-l.py 
```
...
Yolov5 l is under GNU General Public License. 
