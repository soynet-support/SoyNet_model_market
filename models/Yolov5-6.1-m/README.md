...
```
$ cd SoyNet_model_market/models/Yolov5-6.1-m/weights && bash ./download_weights.sh
```

* Run
```
$ cd ../../../samples
$ python Yolov5-6.1-m.py 
```
...
Yolov5 m is under GNU General Public License. 
