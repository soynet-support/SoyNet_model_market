...
```
$ cd SoyNet_model_market/models/Yolov5-6.1-x/weights && bash ./download_weights.sh
```

* Run
```
$ cd ../../../samples
$ python Yolov5-6.1-x.py 
```
...
Yolov5 x is under GNU General Public License. 
