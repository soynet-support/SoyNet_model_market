...
def parse_args(argv=None):
    ...
    parser.add_argument('--video', default="NY.mkv", type=str,
        ...
        for j in reversed(range(num_dets_to_consider)):
            ...
            if args.display_text:
                ...
                cv2.putText(img_numpy, text_str, text_pt, font_face, font_scale, text_color, font_thickness,
                            cv2.LINE_AA)
            # text_str = '%3d ( %6d %6d %6d %6d ) %3d obj= %15s: %.6f' % (j , x1 , y1 , x2 , y2, classes[j],_class,score)
            # print(text_str)
            # print(j , x1 , y1 , x2 , y2, classes[j],_class,score)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        pytorch_weight = 'weights/yolact_resnet50_54_800000.pth' # 파이토치 웨이트 파일
        backbone = "101"  # 50, 101
        soynet_weight = 'yolact-resnet{}.weights'.format(backbone)  # 소이넷 웨이트 파일

        net = Yolact()
        net.load_weights(pytorch_weight)

        if 1:  # weight download
            print()
            with open(soynet_weight, 'wb') as f:
                f.write(np.array([0] * 10, dtype=np.float32))
                ...
                if backbone == "50":
                    ...
                    print()
                    for idx in range(0, 312):  # BACKBONE
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
                        ...
                        print(0, idx, key, value.shape)
                    print()
                    for idx in range(328, 344):  # LAT, PRED, DOWN
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
                        ...
                        print(0, idx, key, value.shape)
                    print()
                    for idx in range(318, 328):  # PROTO
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
                        ...
                        print(0, idx, key, value.shape)
                    print()
                    for iter in range(5):  # PRED Layer
                        for idx in range(344, 352):
                            key, value = weight_list[idx]
                            if "num_batches_tracked" in key:
                                print(idx, "--------------------")
                                continue
                            w = value.cpu().data.numpy()
                            f.write(w)
                            print(iter, idx, key, value.shape)
                    print()
                    for idx in range(352, 352):
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
                ...
                if backbone == "101":
                    for idx in range(618, 623):  # STEM
                        ...
                        print(0, idx, key, value.shape)
                    print()
                    for idx in range(0, 617):  # BACKBONE
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
                        ...
                        print(0, idx, key, value.shape)
                    print()
                    for idx in range(634, 650):  # LAT, PRED, DOWN
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
                        ...
                        print(0, idx, key, value.shape)
                    print()
                    for idx in range(624, 634):  # PROTO
                        key, value = weight_list[idx]
                        if "num_batches_tracked" in key:
                            print(idx, "--------------------")
                            continue
