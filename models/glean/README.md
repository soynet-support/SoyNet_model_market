...
The GLEAN show that pre-trained Generative Adversarial Networks (GANs), can be used as a latent bank to improve the restoration quality of large-factor image super-resolution (SR).
...
```
$ cd SoyNet_model_market/models/glean/weights && bash ./download_weights.sh
```
