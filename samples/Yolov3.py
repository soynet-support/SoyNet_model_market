...
if __name__ == "__main__":
    ...
    model_name = "yolov3"
    cfg_file = "../models/Yolov3/configs/{}.cfg".format(model_name)
    weight_file = "../models/Yolov3/weights/{}.weights".format(model_name)
    engine_file = "../models/Yolov3/engines/{}.bin".format(model_name)
    log_file = "../models/Yolov3/logs/{}.log".format(model_name)
    ...
    # View Result
    ViewResult(img, output, 'Yolov3', nms=nms_count)
