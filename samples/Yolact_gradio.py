...
def predict(img):
    ...
    for b_idx in range(batch_size):
        ...
        for r_idx in rip:
            ...
            cv.putText(masked_img, class_names[obj_id], (x1, y1 - 3), 1, 1.5, (255, 0, 0), 1, cv.LINE_AA)
    return masked_img
...
if __name__ == "__main__":
    ...
    model_name = "yolact-resnet101" # yolact-resnet50
    ...
    demo = gr.Interface(
        ...
        inputs="image",
        outputs="image",
        title='SoyNet Yolact Demo',
        description='This is Yolact demo using SoyNet & Gradio',
