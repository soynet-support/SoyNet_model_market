...
if __name__ == "__main__":
    ...
    model_name = "fasterrcnn-r101-fpn-detectron2"
    cfg_file = "../models/Detectron2_Faster-RCNN/configs/{}.cfg".format(model_name)
    weight_file = "../models/Detectron2_Faster-RCNN/weights/{}.weights".format(model_name)
    engine_file = "../models/Detectron2_Faster-RCNN/engines/{}.bin".format(model_name)
    log_file = "../models/Detectron2_Faster-RCNN/logs/{}.log".format(model_name)

    extend_param = \
        "MODEL_NAME={} BATCH_SIZE={} ENGINE_SERIALIZE={} CLASS_COUNT={} NMS_COUNT={} INPUT_SIZE={},{} " \
        "WEIGHT_FILE={} ENGINE_FILE={} LOG_FILE={}".format(
            model_name, batch_size, engine_serialize, class_count, nms_count, input_height, input_width,
    ...
    # View Result
    ViewResult(img, output, 'Faster-RCNN', nms=nms_count)
