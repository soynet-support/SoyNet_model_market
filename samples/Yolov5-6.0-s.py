...
if __name__ == "__main__":
    ...
    cfg_file = "../models/Yolov5-6.0-s/configs/{}.cfg".format(model_name)
    weight_file = "../models/Yolov5-6.0-s/weights/{}.weights".format(model_name)
    engine_file = "../models/Yolov5-6.0-s/engines/{}.bin".format(model_name)
    log_file = "../models/Yolov5-6.0-s/logs/{}.log".format(model_name)
