...
if __name__ == "__main__":
    ...
    cfg_file = "../models/Yolov5-6.1-x/configs/{}.cfg".format(model_name)
    weight_file = "../models/Yolov5-6.1-x/weights/{}.weights".format(model_name)
    engine_file = "../models/Yolov5-6.1-x/engines/{}.bin".format(model_name)
    log_file = "../models/Yolov5-6.1-x/logs/{}.log".format(model_name)
